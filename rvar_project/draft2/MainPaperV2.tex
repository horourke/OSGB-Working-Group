...
{
	\title{\bf Moderator-Assisted Granger Causal Network Learning for High-Dimensional Multi-Subject Longitudinal Data}
	\author{
...
\noindent
{\it Keywords:} Adaptive estimation, network regression, time series, vector auto-regressive model, weighted networks.
\vfill
