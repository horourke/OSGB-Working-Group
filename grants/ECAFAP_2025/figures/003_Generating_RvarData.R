...
## This new version ensures that entries that are common or individual
## are fully disjoint. This way, it is easier to evaluate the performance
## of individual/joint components.
##
##  INPUTS:
...
generate_rvar_pars <- function(d, p, prob_phi0, prob_phip,
  ...
  ## Create covariate-dependent effects:
  phip_list <- list()
  for (ind in 1:p) {
